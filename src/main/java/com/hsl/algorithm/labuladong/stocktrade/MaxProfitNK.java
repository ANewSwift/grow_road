 ...
 */
public class MaxProfitNK {
    public static void main(String[] args) {
        MaxProfitNK main = new MaxProfitNK();
        int i = main.maxProfit_dp_opt(new int[]{7,1,5,3,6,4});
        System.out.println(i == 7);
//        int i = main.maxProfit(new int[]{1,2,3,4,5});
//        System.out.println(i == 4);
//        int i = main.maxProfit(new int[]{7,6,4,3,1});
